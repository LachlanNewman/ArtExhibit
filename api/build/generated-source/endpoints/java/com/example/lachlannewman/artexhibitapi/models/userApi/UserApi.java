 ...
 * on 2017-10-03 at 06:55:36 UTC 
 * Modify at your own risk.
 */

package com.example.lachlannewman.artexhibitapi.models.userApi;
...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Get extends UserApiRequest<com.example.lachlannewman.artexhibitapi.models.userApi.model.User> {
    ...
    protected Get(java.lang.Long id) {
      super(UserApi.this, "GET", REST_PATH, null, com.example.lachlannewman.artexhibitapi.models.userApi.model.User.class);
   ...
   *
   * @param content the {@link com.example.lachlannewman.artexhibitapi.models.userApi.model.User}
   * @return the request
   */
  public Insert insert(com.example.lachlannewman.artexhibitapi.models.userApi.model.User content) throws java.io.IOException {
    Insert result = new Insert(content);
    initialize(result);
    return result;
  }

  public class Insert extends UserApiRequest<com.example.lachlannewman.artexhibitapi.models.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Insert(com.example.lachlannewman.artexhibitapi.models.userApi.model.User content) {
      super(UserApi.this, "POST", REST_PATH, content, com.example.lachlannewman.artexhibitapi.models.userApi.model.User.class);
    }
  ...
  public class List extends UserApiRequest<com.example.lachlannewman.artexhibitapi.models.userApi.model.CollectionResponseUser> {
     ...
     */
    protected List() {
      super(UserApi.this, "GET", REST_PATH, null, com.example.lachlannewman.artexhibitapi.models.userApi.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public Patch patch(java.lang.Long id, com.example.lachlannewman.artexhibitapi.models.userApi.model.User content) throws java.io.IOException {
    Patch result = new Patch(id, content);
    initialize(result);
    return result;
  }

  public class Patch extends UserApiRequest<com.example.lachlannewman.artexhibitapi.models.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.Long id, com.example.lachlannewman.artexhibitapi.models.userApi.model.User content) {
      super(UserApi.this, "PATCH", REST_PATH, content, com.example.lachlannewman.artexhibitapi.models.userApi.model.User.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public Update update(java.lang.Long id, com.example.lachlannewman.artexhibitapi.models.userApi.model.User content) throws java.io.IOException {
    Update result = new Update(id, content);
    initialize(result);
    return result;
  }

  public class Update extends UserApiRequest<com.example.lachlannewman.artexhibitapi.models.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.Long id, com.example.lachlannewman.artexhibitapi.models.userApi.model.User content) {
      super(UserApi.this, "PUT", REST_PATH, content, com.example.lachlannewman.artexhibitapi.models.userApi.model.User.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
